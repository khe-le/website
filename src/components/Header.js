    ...
    return (
      ...
      <header id="header">
        ...
        <Navbar
          ...
          className={this.state.isTop ? "default" : "sticky"}
        >
            ...
            <Navbar.Brand>
              <img
                ...
                className={`d-inline-block align-top ${
                  this.state.isTop ? "logo-default" : "logo-sticky"
                }`}
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto">
              <ScrollIntoView selector="#about">
                <Nav.Link className="section-link">About</Nav.Link>
              </ScrollIntoView>
              ...
              <ScrollIntoView selector="">
                <Nav.Link
                  ...
                  href="https://drive.google.com/file/d/1zIoDG4gzAP-i3VM2lO8snhFuuzdVjl4n/view?usp=sharing"
                >
                  Resume
                </Nav.Link>
              </ScrollIntoView>
          ...
          <ul>
            ...
            <li>
              <a
                ...
                href="https://www.linkedin.com/in/khe-v-le/"
              >
